...
for i = 1:size(periods,1)
     ...
     pr_extr(:,i)      = mf_extract_prd_eco_leap20y(pr, date_all(:,1), extr_years',i); 
     tas_extr(:,i)     = mf_extract_prd_eco_leap20y(tas, date_all(:,1),extr_years',i);
     tasmin_extr(:,i)  = mf_extract_prd_eco_leap20y(tasmin, date_all(:,1),extr_years',i);
     tasmax_extr(:,i)  = mf_extract_prd_eco_leap20y(tasmax, date_all(:,1),extr_years',i);
     sfcWind_extr(:,i) = mf_extract_prd_eco_leap20y(sfcWind, date_all(:,1),extr_years',i);
     rh_extr(:,i)      = mf_extract_prd_eco_leap20y(rh, date_all(:,1),extr_years',i);
