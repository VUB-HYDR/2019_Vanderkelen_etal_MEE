...
period_05 = mf_GMTperiod_2y(T_anom_30ym, years_GCM, 0.5); 
period_1 = mf_GMTperiod_2y(T_anom_30ym, years_GCM, 1); 
period_15 = mf_GMTperiod_2y(T_anom_30ym, years_GCM, 1.5);
period_2 = mf_GMTperiod_2y(T_anom_30ym, years_GCM, 2);
period_25 = mf_GMTperiod_2y(T_anom_30ym, years_GCM, 2.5);
period_3 = mf_GMTperiod_2y(T_anom_30ym, years_GCM, 3); 
period_35 = mf_GMTperiod_2y(T_anom_30ym, years_GCM, 3.5); 
period_4 = mf_GMTperiod_2y(T_anom_30ym, years_GCM, 4);
period_45 = mf_GMTperiod_2y(T_anom_30ym, years_GCM, 4.5);
...
periods = [ 0, min(period_pi),max(period_pi);
 ...
 filename = strcat('period_', num2str(low_bound), '-',num2str(up_bound), '_30ymean_2y.dat');
