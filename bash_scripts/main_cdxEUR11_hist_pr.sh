...
inDIR=/gpfs/projects/climate/data/dataset/cordex/EUR-11/historical/day

# set variable names

VARs=('rsds' 'sfcWind' 'sfcWindmax' 'tas' 'tasmax' 'tasmin' 'uas' 'vas')
                   ...
                   echo $FORCING 'exists'
                    ...
                    for RCM in "${RCMs[@]}"; do
                        ...
                        for CLASS in "${CLASSes[@]}"; do
                            ...
                            cdo mergetime $VAR/$INSTITUTE/$FORCING/$RCM/$CLASS/$VAR_*.nc $outDIR/historical/temp1.nc 
                            cdo sellonlatbox,5.34,6.06,50.78,51.22 $outDIR/historical/temp1.nc $outDIR/historical/temp2.nc
			
                            mv $outDIR/historical/temp2.nc $outDIR/historical/${VAR}_ecotron_${FORCING}-${RCM}_day_hist.nc
                            rm $outDIR/historical/temp1.nc 
